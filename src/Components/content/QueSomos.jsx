...
const QueSomos = () => {
  return (
    <>
        <div className="container-queSomos mt-5 row justify-content-center align-items-center px-2" id='queSomos'>
            <div className="col-md-8">
                ...
                <p className='text-center mt-2 fs-5'>Somos un oasis de bienestar!</p>
                <p className='text-center fs-5'>En nuestro espacio holístico, la espiritualidad se entrelaza con la salud emocional.</p>
                <p className='text-center fs-5'>Te invitamos a explorar un camino hacia la paz mental y el equilibrio emocional. Conecta con vos mismo, y experimenta una transformación profunda.</p>
